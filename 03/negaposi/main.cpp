...
#define FILE_NAME "/Users/x22004xx/src/imgProc/第三回/negaposi/fruit_image.jpg"

// ウィンドウ名
#define WINDOW_NAME_INPUT "input"
#define WINDOW_NAME_OUTPUT "output"
#define COLOR_NUM (256) // 階調数
#define Imax (255)      // 階調最大値
...
int main(int argc, char const *argv[])
{
    ...
    for (int y = 0; y < dst_img.rows; y++)
    {
        for (int x = 0; x < dst_img.cols; x++)
        {
            ...
            // 階調最大値から現在の参照している画素値を引いた値を出力値とする
            // に格納された出力値を出力画像の画素値とする
            dst_img.at<uchar>(y, x) = Imax - s;
        }
    }
